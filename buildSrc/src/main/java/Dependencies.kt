object Dependencies {
    ...
    const val hiltViewModel = "androidx.hilt:hilt-lifecycle-viewmodel:${Versions.HILT_ANDROIDX}"
    const val hiltAndroidxCompiler = "androidx.hilt:hilt-compiler:${Versions.HILT_ANDROIDX}"
